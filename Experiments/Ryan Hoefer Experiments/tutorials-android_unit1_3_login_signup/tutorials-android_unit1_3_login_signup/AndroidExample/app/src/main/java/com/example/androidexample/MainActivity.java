...
public class MainActivity extends AppCompatActivity {
    ...
    private Button switchToDataButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchToDataButton = findViewById(R.id.switch_to_data_btn);
        ...
        if(extras == null) {
            ...
            switchToDataButton.setVisibility(View.INVISIBLE);// set username text invisible initially
        } else {
            ...
            switchToDataButton.setVisibility(View.VISIBLE);
        ...
        switchToDataButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /* when signup button is pressed, use intent to switch to Signup Activity */
