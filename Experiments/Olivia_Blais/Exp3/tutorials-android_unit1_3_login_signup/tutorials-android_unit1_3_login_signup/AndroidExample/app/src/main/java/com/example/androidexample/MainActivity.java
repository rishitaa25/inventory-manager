...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView submessage; //define welcome textview variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submessage = findViewById(R.id.welcome_msg_txt);  //link to welcome message textview in Main activity XML
        ...
        termsButton = findViewById(R.id.main_terms_btn);

        /* extract data passed into this activity from another activity */
        Bundle extras = getIntent().getExtras();
        if(extras == null) {
            messageText.setText("NEXUS");
        ...
        termsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /* when terms button is pressed, use intent to switch to Signup Activity */
